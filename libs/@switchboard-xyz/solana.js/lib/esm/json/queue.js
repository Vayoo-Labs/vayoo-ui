...
export class QueueJson {
    constructor(object) {
        ...
        this.feedProbationPeriod = parseNumber(object, 'feedProbationPeriod', undefined);
        ...
        this.varianceToleranceMultiplier = parseNumber(object, 'varianceToleranceMultiplier', undefined);
        this.consecutiveFeedFailureLimit = parseNumber(object, 'consecutiveFeedFailureLimit', undefined);
        this.consecutiveOracleFailureLimit = parseNumber(object, 'consecutiveOracleFailureLimit', undefined);
        this.queueSize = parseNumber(object, 'queueSize', 100);
        this.unpermissionedFeeds = parseBoolean(object, 'unpermissionedFeeds', undefined);
        this.unpermissionedVrf = parseBoolean(object, 'unpermissionedVrf', false);
        this.enableBufferRelayers = parseBoolean(object, 'enableBufferRelayers', undefined);
        // accounts
