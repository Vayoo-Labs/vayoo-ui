...
const Trade = () => {
  ...
  return (
    <div className="w-full max-w-sm py-6 text-white flex flex-col gap-3 border-2 border-gray-300/10 rounded-xl bg-black/50 z-10">
        ...
        <div className="flex justify-between gap-4 items-start">
          <div className="flex flex-col items-center">
            ...
            <div className="text-gray-500 text-xs underline-offset-4">
              <a href={selectedContract?.extraInfo.oracle_link}>
                oracle
              </a>
            </div>
          </div>
      ...
      {state?.contractState?.isSettling ? (
        ...
        <div>
          ...
          <p className="my-4 ml-20 px-6 text-red-900 text-sm">{errStr}</p>
          ...
          <div className="mt-4 px-6 mb-1 flex flex-row w-full justify-between gap-3">
            <div className="w-full flex flex-col justify-between items-center py-1 rounded-xl gap-[0.5px]">
              <button
                disabled={
                  state?.userPosition == UserPosition.Short || !tradeEnable
                }
            ...
            <div className="w-full flex flex-col justify-between items-center py-1 border-green-100/60 rounded-xl">
              <button
                disabled={
                  state?.userPosition == UserPosition.Long || !tradeEnable
                }
